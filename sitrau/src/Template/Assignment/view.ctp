...
<div class="assignment view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $assignment->has('teacher') ? $this->Html->link($assignment->teacher->name, ['controller' => 'Teachers', 'action' => 'view', $assignment->teacher->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $assignment->active ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
</div>
