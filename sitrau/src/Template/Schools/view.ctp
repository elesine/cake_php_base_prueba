...
<div class="schools view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $school->active ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($academicSemesters->active) ?></td>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($coordinators->name) ?></td>
                <td><?= h($coordinators->f_surname) ?></td>
                <td><?= h($coordinators->m_surname) ?></td>
                <td><?= h($coordinators->dni) ?></td>
                <td><?= h($coordinators->personal_mail) ?></td>
                <td><?= h($coordinators->institutional_mail) ?></td>
                <td><?= h($coordinators->birth_date) ?></td>
                <td><?= h($coordinators->school_id) ?></td>
                <td><?= h($coordinators->active) ?></td>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($students->f_surname) ?></td>
                <td><?= h($students->m_surname) ?></td>
                <td><?= h($students->dni) ?></td>
                <td><?= h($students->personal_mail) ?></td>
                <td><?= h($students->institutional_mail) ?></td>
