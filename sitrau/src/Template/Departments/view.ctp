    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($directors->f_surname) ?></td>
                <td><?= h($directors->m_surname) ?></td>
                <td><?= h($directors->dni) ?></td>
                <td><?= h($directors->personal_mail) ?></td>
                <td><?= h($directors->institutional_mail) ?></td>
                <td><?= h($directors->birth_date) ?></td>
                <td><?= h($directors->department_id) ?></td>
                <td><?= h($directors->active) ?></td>
