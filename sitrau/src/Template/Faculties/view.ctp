...
<div class="faculties view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $faculty->active ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td><?= h($deans->id) ?></td>
                <td><?= h($deans->name) ?></td>
                <td><?= h($deans->f_surname) ?></td>
                <td><?= h($deans->m_surname) ?></td>
                <td><?= h($deans->dni) ?></td>
                <td><?= h($deans->personal_mail) ?></td>
                <td><?= h($deans->institutional_mail) ?></td>
                <td><?= h($deans->birth_date) ?></td>
                <td><?= h($deans->faculty_id) ?></td>
                <td><?= h($deans->active) ?></td>
