...
class DeansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'deans_ibfk_1' => ['type' => 'foreign', 'columns' => ['faculty_id'], 'references' => ['faculties', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'faculty_id' => 1,
                'active' => 1,
                'created' => '2020-05-22 12:04:56',
                'modified' => '2020-05-22 12:04:56',
            ],
        ];
        parent::init();
    }
