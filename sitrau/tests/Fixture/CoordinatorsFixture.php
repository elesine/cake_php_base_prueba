...
class CoordinatorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'coordinators_ibfk_1' => ['type' => 'foreign', 'columns' => ['school_id'], 'references' => ['schools', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'school_id' => 1,
                'active' => 1,
                'created' => '2020-05-22 12:07:10',
                'modified' => '2020-05-22 12:07:10',
            ],
        ];
        parent::init();
    }
